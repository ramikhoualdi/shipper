  ...
  return (
    <div>
              ...
              <div className="vc_column_inner">
                <div className="wpb_wrapper">
                  <div className="side-content left">
                    ...
                    <p>
                      Qesco Logistics is a leading third party contract
                      logistics company based in the Midlands, United Kingdom.
                      We specialise in providing supply-chain warehousing and
                      transport services throughout the UK, Ireland and
                      Continental Europe.
                    </p>
                    <Link to="/logistics" className="custom-button">
                ...
                <div className="wpb_wrapper">
                  <div className="icon-box  ">
                    <div className="inner">
                      ...
                      <h6>Leadership</h6>
                      <p>
                        Experts who have extensive, hands-on experience in
                ...
                <div className="wpb_wrapper">
                  <div className="icon-box  ">
                    <div className="inner">
                      ...
                      <h6>Technology</h6>
                      <p>
                        Innovative and varied use of technology on the road,
                        ocean, railways, in the air.
                      </p>
                      <Link to="/services" className="custom-link">
                        Connect with an Expert
                      </Link>
                ...
                <div className="wpb_wrapper">
                  <div className="icon-box  ">
                    <div className="inner">
                      ...
                      <h6>Solution</h6>
                      <p>
                        Global leaders in intermodal, less-than-truckload,
                        supply chain management.
                      </p>
                      <Link to="/services" className="custom-link">
                        Connect with an Expert
                  ...
                  <figure className="side-image full-right ">
                    <div className="info-box">
                      <figure>
                        <img
                          src={
                            process.env.PUBLIC_URL + "/images/icon-infobox.png"
                          }
                          alt="alt"
                        />
                      </figure>
                      <p>
                        Personnel deliver bespoke
                        <br />
                        solutions that are designed
                        <br />
                        to increase speed to market, <br />
                        <strong>simplify inventory</strong>
                        <br /> management,
                        <br />
      ...
      <section
        ...
        style={{
          background: `url(${
            process.env.PUBLIC_URL + "/images/section-bg-01.jpg"
          }) center no-repeat`,
        }}
      >
                      ...
                      <div className="vc_column-inner vc_custom_1604126352374">
                        <div className="wpb_wrapper">
                          <div
                            ...
                            style={{ color: "#212223", textAlign: "left" }}
                          >
                            <h6> TOTAL DELIVERY COST </h6>
                            <h2>
                              Find out the approximate cost of
                              <br />
                    ...
                    <div className="swiper-wrapper">
                      ...
                      >
                        <div className="testimonial">
                          <p>
                            As a first time importer from the Far East, the
                            process can be quite daunting. John Good has
                            provided exceptional service and support right
                            through exceptional the process.
                          </p>
                      ...
                      >
                        <div className="testimonial">
                          <p>
                            Far East, the process can be quite daunting. John
                            Good has provided exceptional service and support
                            right through the process As a first time importer
                            from the.
                          </p>
                          <h6>Alex Olevnik</h6>
                      ...
                      <div className="swiper-slide" style={{ width: "495px" }}>
                        <div className="testimonial">
                          <p>
                            John Good has provided exceptional service and
                            support right through the process As a first time
                            importer from the. Far East, the process can be
                            quite daunting.{" "}
                          </p>
                          <h6>Jack Abraham</h6>
                      ...
                      <div className="vc_column-inner">
                        <div className="wpb_wrapper">
                          <figure className="logo-item ">
                            <img
                              src={
                                process.env.PUBLIC_URL + "/images/logo01.jpg"
                              }
                              alt="alt"
                            />
                          </figure>
                      ...
                      <div className="vc_column-inner">
                        <div className="wpb_wrapper">
                          <figure className="logo-item">
                            <img
                              src={
                                process.env.PUBLIC_URL + "/images/logo02.jpg"
                              }
                              alt="alt"
                            />
                          </figure>
                      ...
                      <div className="vc_column-inner">
                        <div className="wpb_wrapper">
                          <figure className="logo-item">
                            <img
                              src={
                                process.env.PUBLIC_URL + "/images/logo03.jpg"
                              }
                              alt="alt"
                            />
                          </figure>
                      ...
                      <div className="vc_column-inner">
                        <div className="wpb_wrapper">
                          <figure className="logo-item">
                            <img
                              src={
                                process.env.PUBLIC_URL + "/images/logo04.jpg"
                              }
                              alt="alt"
                            />
                          </figure>
                    ...
                    <div className="col-md-6">
                      <div className="recent-news">
                        ...
                        <div className="content">
                          <h3>
                            <Link to="/blog/expression-alteration-entreaties-mrs-can-terminated-estimating">
                              Expression alteration entreaties mrs can
                              terminated estimating.
                            </Link>
                          </h3>
                          <small> 31st October, 2021</small>
                          <p>
                            Design is our playground. While we create an awesome
                            experience, we like having fun. No an
                          </p>
                          <span>
                            <BiCommentDetail
                              style={{
                    ...
                    <div className="col-md-6">
                      <div className="recent-news ">
                        ...
                        <div className="content">
                          <h3>
                            <Link to="/blog/subject-but-why-ten-earnest-husband-imagine-sixteen-brandon">
                              Subject but why ten earnest husband imagine
                              sixteen brandon.
                            </Link>
                          </h3>
                          <small> 31st October, 2021</small>
